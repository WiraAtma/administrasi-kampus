...
Route::put('/filter-mahasiswa/{id}', [MahasiswaController::class, 'update'])->middleware('auth');
Route::get('/mahasiswa-delete/{id}', [MahasiswaController::class, 'delete'])->middleware([AdminAccess]);
Route::delete('/filter-delete-mahasiswa/{id}', [MahasiswaController::class, 'destroy'])->middleware('auth');
Route::get('/mahasiswa-temporary', [MahasiswaController::class, 'mahasiswaDeleted'])->middleware('auth');
Route::get('/filter-restore-mahasiswa/{id}', [MahasiswaController::class, 'restore'])->middleware('auth');
...
Route::get('/prodi-edit/{id}', [ProdiController::class, 'edit'])->middleware('auth');
Route::post('/filter-prodi/{id}', [ProdiController::class, 'update'])->middleware('auth');
Route::get('/prodi-delete/{id}', [ProdiController::class, 'delete'])->middleware('auth');
Route::delete('/filter-delete-prodi/{id}', [ProdiController::class, 'destroy'])->middleware('auth');
