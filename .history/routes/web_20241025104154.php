...
Route::get('/mahasiswa-create', [MahasiswaController::class, 'create'])->middleware([AdminAccess::class]);
Route::post('/filter-mahasiswa', [MahasiswaController::class, 'store'])->middleware([AdminAccess::class]);
...
Route::get('/prodi-create', [ProdiController::class, 'create'])->middleware([AdminAccess::class]);
Route::post('/filter-prodi', [ProdiController::class, 'store'])->middleware([AdminAccess::class]);
...
Route::get('/prodi-temporary', [ProdiController::class, 'prodiDeleted'])->middleware([AdminAccess::class]);
Route::get('/filter-restore-prodi/{id}', [ProdiController::class, 'restore'])->middleware([AdminAccess::class]);
